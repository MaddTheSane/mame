...
// еее			case CPUINFO_INT_REGISTER + M68K_PREF_ADDR:		info->i = m68ec020_get_reg_ppc(M68K_REG_PREF_ADDR); break;
// еее			case CPUINFO_INT_REGISTER + M68K_PREF_DATA:		info->i = m68ec020_get_reg_ppc(M68K_REG_PREF_DATA); break;
...
// еее			case CPUINFO_STR_REGISTER + M68K_PREF_ADDR:		sprintf(info->s = cpuintrf_temp_str(), "PAR:%08X", m68ec020_get_reg_ppc(M68K_REG_PREF_ADDR)); break;
// еее			case CPUINFO_STR_REGISTER + M68K_PREF_DATA:		sprintf(info->s = cpuintrf_temp_str(), "PDA:%08X", m68ec020_get_reg_ppc(M68K_REG_PREF_DATA)); break;
