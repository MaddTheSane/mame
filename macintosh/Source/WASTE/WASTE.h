 ...
 *
 *	version 2.1a3 (October 2001)
 *
 *	Copyright (c) 1993-2001 Marco Piovanelli
 *	All Rights Reserved
 *
...
#define WASTE_VERSION	0x02104003		/* 2.1a3 */
...
/*	the following meta-selectors are only valid in calls to WESetAttributes/WESetOneAttribute */
	...
	weTagAddLineSpacing			=	FOUR_CHAR_CODE('+led'), /* like weTagLineSpacing, but value is added rather than replaced */
...
enum
{
	weAutoScrollDelay			=	FOUR_CHAR_CODE('ausd'), /* for use by the click loop callback (Carbon only) */
...
/*	WEGetAlignment/WESetAlignment are deprecated in WASTE 2.0 -- please use WEGetOneAttribute/WESetOneAttribute instead */
...
/*	WEGetDirection/WESetDirection are deprecated in WASTE 2.0 -- please use WEGetOneAttribute/WESetOneAttribute instead */
