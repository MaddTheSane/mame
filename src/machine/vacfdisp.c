...
static struct
{
  UINT8	  type,				// type of alpha display
		  ...
		  changed;			// flag <>0, if vfd contents is changed
...
{         // FEDC BA98 7654 3210
  ...
  0x0000, // 0000 0000 0000 0000 flash
  ...
  0xFFFF, // 0000 0000 0000 0000 user defined
